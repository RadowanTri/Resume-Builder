...
const Footer = () => {
  return (
    <div>
      <footer class="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-emerald-900">
          ...
          <div>
            ...
            <ul class="mt-2 space-y-2">
              ...
              <li>
                <a href="/" class="hover:text-green-600 transition">
                  Careers
                  <span class="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">
                    We’re hiring!
                  </span>
                </a>
              </li>
        ...
        <div class="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          ...
          <div class="flex items-center gap-4 mt-3">
            ...
            >
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-dribbble size-5 hover:text-green-500"
                aria-hidden="true"
              >
            ...
            >
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-linkedin size-5 hover:text-green-500"
                aria-hidden="true"
              >
            ...
            <a href="https://x.com/prebuiltui" target="_blank" rel="noreferrer">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-twitter size-5 hover:text-green-500"
                aria-hidden="true"
              >
            ...
            >
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-youtube size-6 hover:text-green-500"
                aria-hidden="true"
              >
          ...
          <p class="mt-3 text-center">
            © 2025 
            {/* <Link to={<>https://timerni.com/</>}>Timenri </Link> */}
          </p>
        </div>
      </footer>
    </div>
